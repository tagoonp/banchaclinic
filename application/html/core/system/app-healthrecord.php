        ...
        <div class="content-wrapper">
            ...
            <div class="modal fade text-left" id="modalMedPHRQuick" tabindex="-1" role="dialog" aria-labelledby="myModalLabel110" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header bg-success">
                            <h5 class="modal-title white" id="myModalLabel110"><i class="bx bxs-user-plus"></i> เพิ่มรายการยา</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"  onclick="resetDrugform();">
                                <i class="bx bx-x"></i>
                            </button>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="txtfTotal_real" name="txtfTotal_real" min="0" placeholder="" step="any" value="<?php if($lasted_adm['service_finalprice'] != 0){ echo $lasted_adm['service_finalprice']; }  ?>">
                                        </div>
                                    </div>
                                </div>
