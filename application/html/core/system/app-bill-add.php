            ...
            <div class="content-header row">
                <div class="content-header-left col-8 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        <h5 class="content-header-title float-left pr-1 mb-0 text-dark" style="font-size: 28px;">เข้าบิลยาใหม่</h5>
                        <div class="breadcrumb-wrapper d-none d-sm-block" style="padding-top: 10px;">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="breadcrumb-item"><a href="./"><i class="bx bx-home-alt"></i></a></li>
                                <li class="breadcrumb-item"><a href="./app-bill-list.php">บิล/Check</a></li>
                                <li class="breadcrumb-item active">เข้าบิลยาใหม่</li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="col-4 text-right pt-1">
                <button class="btn btn-danger pl-1" onclick="window.location='./app-bill-list.php'"><i class="bx bx-list-ul"></i> รายการบิลทั้ังหมด</button>
                </div>
            </div>
