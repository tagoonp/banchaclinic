            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        <h5 class="content-header-title float-left pr-1 mb-0 text-dark" style="font-size: 28px;">จัดการยาคงคลัง</h5>
                        <div class="breadcrumb-wrapper d-none d-sm-block" style="padding-top: 10px;">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                ...
                                <li class="breadcrumb-item active">จัดการยาคงคลัง</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table table-striped dataex-html5-selectors mt-0" style="width: 100%;">
                                    <thead class="thead-dark">
                                        ...
                                        <tr style="font-weight: 400;">
                                            <td style="width: 100px;" class="pl-1 pr-1">ID</td>
                                            <td>Trade name</td>
                                            <td>Generic name</td>
                                            <td>Dose</td>
                                            <td style="width: 100px;">In stock</td>
                                    ...
                                    if($result['status']){
                                        ...
                                        foreach ($result['data'] as $row) {
                                            ?>
                                            <tr>
                                                <td class="pl-1 pr-1" id="ddid_<?php echo $row['ID']; ?>"><a href="Javascript:void(0)" class=""><?php echo $row['did'];?></a></td>
                                                ...
                                                <td id="dstock_<?php echo $row['ID']; ?>">
                                                    <?php echo $row['dstock'];?>
                                                </td>
                                                <td style="vertical-align: top;" class="text-right pr-1">
                                                        <button class="btn btn-icon rounded-circle btn-success" style="height: 40px; width: 40px; padding-top: 1px; margin-bottom: 3px;" id="btnUpdateDrugStock" onclick="updateDrugStock('<?php echo $row['ID']; ?>', '<?php echo $row['dname'];?>', '<?php echo $row['dstock'];?>')"><i class="bx bx-plus" style="font-size: 1.3em;"></i></button>
                                                        <button class="btn btn-icon rounded-circle btn-danger" style="height: 40px; width: 40px; padding-top: 1px; margin-bottom: 3px;" id="btnEditDrugStock" onclick="editDrugStock('<?php echo $row['ID']; ?>', '<?php echo $row['dname'];?>', '<?php echo $row['dstock'];?>')"><i class="bx bxs-pencil" style="font-size: 1.3em;"></i></button>
                                                </td>
                                            </tr>
                                            <?php
                                        }
